...
class PolicyBenchTests(unittest.TestCase):
    ...
    def test_dashboard_is_self_contained(self) -> None:
        ...
        self.assertIn("DuckWing", content)
        ...
        self.assertIn("LIVE TRAINING", content)
        self.assertIn("training-reward-line", content)
        self.assertIn("training-current-reward", content)
        self.assertIn("training-checkpoint", content)
